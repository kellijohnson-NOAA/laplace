...
update_r4ss_files(local=paste(MiscFile,"R4SS/",sep=""),save=FALSE)    # integrate(f=function(x){DtruncnormFn(x,truncmean=0.6,truncsd=0.1,a=0.2,b=1)},lower=0.2,upper=1)

# Load scripts
source(paste(SourceFile,"Fn_Laplace_Approx_2013-08-15b.R",sep=""))
source(paste(SourceFile,"Fn_SS_testing_2013-08-26.R",sep=""))
