...
# Test function call
Iteration = 0
NegLogInt_Fn(File=DateFile, Input_SD_Group_Vec=Input_SD_Group_Vec, CTL_linenum_List=CTL_linenum_List, ESTPAR_num_List=ESTPAR_num_List, Int_Group_List=Int_Group_List, PAR_num_Vec=PAR_num_Vec, Version=Version, Intern=FALSE, ReDoBiasRamp=ReDoBiasRamp, BiasRamp_linenum_Vec=BiasRamp_linenum_Vec, CTL_linenum_Type=CTL_linenum_Type)

# Single-dimensional
Iteration = 0
  if("Optimization_record.txt" %in% list.files(DateFile)) file.remove(paste(DateFile,"Optimization_record.txt",sep=""))
Opt = optimize(f=NegLogInt_Fn, interval=c(Lower,Upper), maximum=FALSE, File=DateFile, CTL_linenum_List=CTL_linenum_List, ESTPAR_num_List=ESTPAR_num_List, Int_Group_List=Int_Group_List, PAR_num_Vec=PAR_num_Vec, Version=Version, Intern=FALSE, ReDoBiasRamp=ReDoBiasRamp, BiasRamp_linenum_Vec=BiasRamp_linenum_Vec, CTL_linenum_Type=CTL_linenum_Type)


######################
# Extracts Hessian from ADMB output files
######################
...
######################
# Calculates laplace approximation
######################
